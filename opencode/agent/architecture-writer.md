...
- **Create mode** (no existing files): read
  `%%AI_PLUGINS_ROOT%%/assets/templates/registry.yaml` and
  `%%AI_PLUGINS_ROOT%%/assets/templates/architecture.md` as the starting
...
asset `%%AI_PLUGINS_ROOT%%/assets/capability-vocabulary.md`; read it and
