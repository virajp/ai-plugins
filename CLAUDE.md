...
- `skills/` (workflow) — the `/vwf:` workflow skills (each
  ...
  | `readme`             | Scans the repo and writes/updates its README against the eight required sections. Absorbed from the retired `markdown` plugin; `invocation: both` **because `docs-sync.md` routes a drifted README through it** — `setup` only names it in the chain it prints                                                                                                                     | —                                                                                                                                                                                                                    |
