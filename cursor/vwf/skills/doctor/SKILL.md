...
`/setup`, and check what you can from its platforms' templates meanwhile.
...
Nudge `/setup` and stop there; a template doctor guessed would silently
...
`/plan` does not, since it compiles nothing.
