...
reality therefore ends by delegating to /docs-sync, in the
...
/docs-sync owns it: scope resolution, the
`docs-sync-surveyor` scan (graph-first), surgical edits, the
/readme route for broad README drift, the change-log hook,
