<!-- Template for /screens prompt — written to
     ...
     it into the canvas chat themselves — /screens never runs it. The
     ...
     and frame codes are the sync keys — /screens import matches by them;
