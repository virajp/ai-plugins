...
| Tool            | Read                                                                                                |
| --------------- | ----------------------------------------------------------------------------------------------------- |
| `claude-design` | [claude-design](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-screens/references/claude-design.md) |
| `lovable`       | [lovable](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-screens/references/lovable.md)             |
| `stitch`        | [stitch](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-screens/references/stitch.md)               |
