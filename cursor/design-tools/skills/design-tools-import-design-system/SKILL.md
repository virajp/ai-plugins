...
`design.tool` is drift for `/setup`'s `12 → 13` migration to copy down;
...
| Tool            | Read                                                                                                      |
| --------------- | ----------------------------------------------------------------------------------------------------------- |
| `claude-design` | [claude-design](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-design-system/references/claude-design.md) |
| `lovable`       | [lovable](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-design-system/references/lovable.md)             |
| `stitch`        | [stitch](%%AI_PLUGINS_ROOT%%/skills/design-tools-import-design-system/references/stitch.md)               |
