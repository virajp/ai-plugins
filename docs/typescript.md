...
| `package-json` | package.json, single-package-first with a monorepo section: pnpm-only, `"latest"` versions, ESM, the exports map, `workspace:*` links, standard build/check/clean/test scripts.                                                                                                                                                               | Auto-applies on `**/package.json`                                             |
