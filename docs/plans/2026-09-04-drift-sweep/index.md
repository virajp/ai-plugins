...
| U6 | 2    | [06-docs-user.md](06-docs-user.md)                 | `readme.md`, `docs/installer/**`, `docs/plugins/**`, `docs/how-to/**`                                                                                                              | U1–U5      | pending |          |
| U7 | 2    | [07-docs-maintainer.md](07-docs-maintainer.md)     | `CLAUDE.md`, `installer/CLAUDE.md`, `.claude/docs/**`, `.claude/skills/**`, `.claude/agents/**`                                                                                    | U1–U5      | pending |          |
