...
| -- | ---- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------- | ------ |
| U1 | 1    | [01-markdown-mirror.md](01-markdown-mirror.md)               | `site/src/lib/markdown.ts`, `site/src/pages/[...path].md.ts`, `site/src/pages/llms.txt.ts`, `site/src/pages/llms-full.txt.ts`                                                                                                                    | —          | pending |        |
| U2 | 1    | [02-icons-manifest-headers.md](02-icons-manifest-headers.md) | `.config/mise/tasks/site/icons`, `site/public/favicon.ico`, `site/public/apple-touch-icon.png`, `site/public/icon-192.png`, `site/public/icon-512.png`, `site/public/site.webmanifest`, `site/public/_headers`, `.config/pre-commit-config.yaml` | —          | pending |        |
