...
**COMPLETE** — 2026-09-04. Ran in worktree `.worktrees/2026-09-04-drift-sweep`
on branch `2026-09-04-drift-sweep`; every unit green, no unit skipped, no
contested findings. Commits, in order: 8ae7c29f (U5), 47feef3a (U1), 16ea66ef
(U2), 952b92f3 (U3), b2887eeb (U4), 9394d649 (plan, wave 1), 6b53fe47 (U6),
3426114a (U7), 8c83a999 (plan, wave 2), 4746e866 (U8). Versions: vwf 19.11.0,
stackgen 0.22.0, installer unchanged. Releases not yet cut.
...
| U8 | 3    | [08-gates-and-bump.md](08-gates-and-bump.md)       | `plugins/vwf/.claude-plugin/plugin.json`, `plugins/stackgen/.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `plugins/stackgen/stacks/inventory.md`                 | U6, U7     | green  | 4746e866 |
...
| 3    | U8              | inherit | 1     | green        | vwf 19.10.0 → 19.11.0, stackgen 0.21.0 → 0.22.0, stackgen description clause rewritten; marketplace.json and inventory.md regenerated (only the two firebase rows changed); all nine gate commands pass. DECIDED: em-dash escape style preserved in the manifest                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                              |
| 3    | R3              | inherit | 1     | pass         | FINDINGS 0, CONTRACT clean, RULINGS clean; versions plain X.Y.Z, generated files up to date, JSON escape style unchanged                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                                              |
| 3    | target-verifier | inherit | 1     | pass         | hermetic CLAUDE_CONFIG_DIR, claude 2.1.260: validate --strict both plugins pass; dev-marketplace install of vwf pulls stackgen, list reports 19.11.0 / 0.22.0; uninstall leaves registrations clean, cache tree survives. Item 3 (doctor reads a goldens stamp) proved statically — doctor validates against harness.md's eight-row table, which carries goldens and test:load, so no unknown-key report is possible; a live `claude -p /vwf:doctor` was blocked by keychain auth in the hermetic dir. GAP: `.dev-marketplace/plugins/` staging is empty on an unregistered machine, so the verifier staged copies itself                                                                                                                                                                                                                |                                              |
| 3    | gate            | —       | 1     | green        | U8's nine gate lines pass; orchestrator gates: pre-commit dry run shows marketplace → inventory → check (after U5), target-verifier above. No unit skipped, failed or unresolved; no contested findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 4746e866                                     |
