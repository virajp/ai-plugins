...
**COMPLETE** 2026-09-05 — commits 0ca49f0, 2866134, 2e77140, ff7e645, aacad61,
1a43c20, f57ef87, 7ad714e (plus the plan's own docs commits); landed from
worktree `.claude/worktrees/2026-09-05-website`.
`.claude/worktrees/2026-09-05-website` (branch `2026-09-05-website`) with
`ERR_PNPM_IGNORED_BUILDS` (sharp via astro, workerd via wrangler); ruling needed
on `pnpm-workspace.yaml` `allowBuilds` (add `sharp: false` and `workerd: false`,
or `strictDepBuilds: false`), which the plan's "No `allowBuilds` change" line
forbids; U4, U5 skipped (depend on U1). Worktree
`.claude/worktrees/2026-09-05-website` (branch `2026-09-05-website`); U1's 24
files and `pnpm-lock.yaml` sit uncommitted in it.
`.claude/worktrees/2026-09-05-website` (branch `2026-09-05-website`)
...
No root `package.json` change. `allowBuilds` gains two **explicit denies**,
`sharp: false` and `workerd: false` (ruled 2026-09-05 at the wave-2 block: pnpm
11's strict dependency builds otherwise fail the install with
`ERR_PNPM_IGNORED_BUILDS`; denying keeps decision 12's no-sharp-build intent).
U3 owns the edit. The workspace entry is U3's.

## Units

| Id | Wave | Unit file                          | Owns                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Depends on | Status | Commit  |
| -- | ---- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------ | ------- |
| U3 | 1    | [03-tooling.md](03-tooling.md)     | `pnpm-workspace.yaml`, `.gitignore`, `.graphifyignore`, `dprint.json`, `.config/linter.yaml`, `.config/pre-commit-config.yaml`, `.config/mise/tasks/site/**`, `.github/workflows/site.yml`                                                                                                                                                                                                                                                                         | —          | green  | 0ca49f0 |
| U1 | 2    | [01-scaffold.md](01-scaffold.md)   | `site/**` **except** `site/src/content/docs/**`, `site/public/brand/**` and `site/CLAUDE.md`; `pnpm-lock.yaml`                                                                                                                                                                                                                                                                                                                                                     | U3         | green  | f57ef87 |
| U2 | 2    | [02-docs-move.md](02-docs-move.md) | `docs/plugins/**`, `docs/how-to/**`, `docs/installer/**`, `docs/assets/**` (moved away), `site/src/content/docs/**`, `site/public/brand/**` (moved to)                                                                                                                                                                                                                                                                                                             | U3         | green  | 2e77140 |
| U4 | 3    | [04-docs.md](04-docs.md)           | `readme.md`, `CLAUDE.md`, `installer/CLAUDE.md`, `site/CLAUDE.md`, `.claude/docs/**`, `.claude/agents/docs-reconciler.md`, `.claude/skills/vwf-plugin/SKILL.md`, `.claude/skills/stackgen-plugin/SKILL.md`, `.claude/skills/plugin-authoring/SKILL.md`, `.claude/skills/release/SKILL.md`, `.claude/skills/create-plan/SKILL.md`, `.claude/skills/execute-plan/SKILL.md`, `mempalace.yaml`, `docs/memory/decisions/2026-09-05-website-on-workers-static-assets.md` | U1, U2     | green  | 7ad714e |
| U5 | 4    | [05-gates.md](05-gates.md)         | `.claude-plugin/marketplace.json`, `plugins/stackgen/stacks/inventory.md` (regenerated, expected unchanged)                                                                                                                                                                                                                                                                                                                                                        | U4         | green  | —       |
...
| ---- | --------------- | ------- | ----- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| 0    | preflight       | —       | 1     | green        | 7/7 gate lines green on develop @ eea02976 (vitest 256 passed, 2 skipped)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | —       |
| 1    | U3              | inherit | 1     | green        | 12 files. DECIDED: pre-commit linter exclude keeps docs/assets beside site/public/brand until U2 moves the tree (straight replace turned pre-commit red in wave 1); deploy job adds mise-action + pnpm install so the pinned wrangler deploys; upload-artifact@v7 / download-artifact@v8 with if-no-files-found error; wrangler-action SHA verified = v4.0.0. GAP: site/release comments reworded from release.yml/npm to site.yml/deploy; pre-commit reformatted the run-log table padding. DOCS FALSIFIED: pre-commit exclude docs/assets half must be dropped after U2 (orchestrator: re-dispatch U3 after wave 2); 03-tooling.md names .config/mise/config.toml, init task lives in .config/mise.toml.                                                                                                                                                                                                                                                                                                                                                                 |         |
| 1    | R1              | inherit | 1     | findings(2)  | site.yml:116 deploy verifies before mise-action, node is the runner's not mise's (→ U3 round 2); CLAUDE.md/ci-and-releases/release SKILL "two tag families" falsified by site-v* — U4's by decision 21, not looped. release.yml untouched; deploy if ref_type==tag + two verify steps confirmed; wrangler-action SHA = v4.0.0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |         |
| 1    | U3              | inherit | 2     | green        | site.yml deploy job reordered: mise-action + pnpm install before the two verify steps.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 0ca49f0 |
| 1    | R1              | inherit | 2     | pass         | finding 1 resolved; CONTRACT clean; RULINGS clean.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |         |
| 2    | U2              | inherit | 1     | green        | 27 renames staged, frontmatter on 19 pages, 12 escaping links absolute. DECIDED: usage.md title em-dash → colon; 4 links whose text was the literal path now read "readme.md"; order values from decision 7 (nav.ts absent at unit time); scoped dprint fmt rewrapped prose around widened links; moved-tree edits staged so renames stay R. DOCS FALSIFIED: 02-docs-move.md:107-109 grep hits 14 not 12 (2 backticked prose mentions); index.md Units table padding. GAP: site:build unprovable until U1 (gate proves it); descriptions are paraphrased one-liners, not verbatim.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 2e77140 |
| 2    | U1              | inherit | 1     | unresolved   | 24 files: package.json, tsconfig, astro.config, wrangler.jsonc, content.config, routes/remark-docs-links/nav, tokens/global css, Base/Docs layouts, Nav/Search/Footer/Mark, index/[...slug]/plugins index/404 pages, mermaid.ts, check-links.ts, robots.txt, pnpm-lock. DECIDED: astro ^6.4.8 (latest is 7.x, plan names 6.x); typescript ^6 (astro check peers ^5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |         |
| 2    | U3              | inherit | 3     | green        | pre-commit linter exclude now ^site/public/brand/ alone (docs/assets gone after U2).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 2866134 |
| 2    | R2              | inherit | 1     | findings(2)  | routes.ts:14 trailing-index regex lacks a slash boundary (how-to/reindex → /how-to/re/), latent; plugins/index.astro:15 breadcrumb reads Docs / Plugins / Plugins. Both → U1 round 2. CONTRACT clean; RULINGS clean; landing copy verbatim, remark plugin throws on escapes, anchors and mermaid verified.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |         |
| 2    | U1              | inherit | 2     | unresolved   | routes.ts strips only a whole /index segment; Docs.astro ends the crumb at the section for a generated index (Docs / Plugins). Rebuilt via binaries: 22 pages, pagefind 20, 1302 links / 496 fragments clean. UNRESOLVED unchanged (allowBuilds).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |         |
| 2    | R2              | inherit | 2     | pass         | both findings resolved; CONTRACT clean; RULINGS clean.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |         |
| 2    | gate            | —       | 1     | red          | green: plugins:check, marketplace --check, inventory --check, vitest 256 passed / 2 skipped, tsc installer + scripts, npm-normalize 33 cases, dprint. red: `pnpm install --frozen-lockfile` (ERR_PNPM_IGNORED_BUILDS sharp@0.34.5 + workerd — reproduced on a fresh site/node_modules), `mise run site:check` and sort-package-json (pnpm exec refuses while the install is red). Attributed to U1's UNRESOLVED.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | —       |
| 2    | orchestrator    | —       | 1     | pass         | render: landing screenshot matches Site_-_Landing.png section for section (nav, blue-sheet hero + construction drawing, phases rail, install split, bento, 2×2 caveats, guides table; footer confirmed in DOM with the three columns Read / Source / Credits); docs page shows tinted sidebar with node marker, breadcrumb Docs / Plugins / vwf plugin, prerequisites table, outline; both mermaid fences render to SVG (2 svg, 0 raw pre after a 60 s virtual-time budget); landing 0 em-dashes and 0 scripts, vwf page 360 em-dashes all from the moved markdown. anchor: id="vwfarchitecture" ×1 in dist/plugins/vwf/index.html; how-to pages link /plugins/vwf/#vwfarchitecture. wrangler deploy --dry-run: 198 assets, exits at the dry-run point. release.yml byte-identical.                                                                                                                                                                                                                                                                                        | —       |
| 3    | U4              | —       | —     | skipped      | depends on U1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | —       |
| 4    | U5              | —       | —     | skipped      | depends on U1 (via U4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | —       |
| 2    | U3              | inherit | 4     | green        | resume: allowBuilds sharp: false + workerd: false per the ruling; frozen-lockfile install exits 0, pnpm no longer rewrites the file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | ff7e645 |
| 2    | U1              | inherit | 3     | green        | resume: no file changed; real entry points pass — frozen install 0, site:check 0 (astro check 0/0, 22 pages, pagefind 20, 1302 links / 496 fragments), wrangler dry-run 0, six required dist files present, no Google Fonts, 0 em-dashes in index.astro. UNRESOLVED: none.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |         |
| 2    | U1              | inherit | 4     | green        | site/package.json sorted for sort-package-json; code:format names nothing under site/.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |         |
| 2    | gate            | —       | 2     | green        | resume: all lines green — plugins:check, marketplace/inventory --check, vitest 256/2 skipped, tsc ×2, npm-normalize 33, frozen install 0, site:check (22 pages, pagefind 20, 1302 links / 496 fragments), code:format, pre-commit --all-files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —       |
| 2    | U1              | inherit | 5     | green        | stale eslint-disable directive removed from remark-docs-links.ts (linter --fix had left a blank line).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |         |
| 2    | U3              | inherit | 5     | green        | pre-commit linter exclude gains \.astro$ — ignored .astro paths each warn and enough warnings fail the hook.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | aacad61 |
| 2    | U3              | inherit | 6     | green        | linter.yaml configs block for site/**/*.css: css/no-invalid-properties allowUnknownVariables (tokens.css defines what global.css consumes), tailwindcss/* off (no Tailwind). GAP: decision 16 named no linter rule config for the stylesheets; taken as an omission, block not ignore.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 1a43c20 |
| 2    | U1              | inherit | 6     | green        | css/no-important: !important dropped from .article pre; a shiki transformer strips only the inline background-color, renders identically (site:build 22 pages, pagefind 20, linter pass).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | f57ef87 |
| 2    | gate            | —       | 3     | green        | on the committed tree after the linter rounds: every line green (vitest 256/2, tsc ×2, npm-normalize 33, frozen install, site:check 22 pages / pagefind 20 / 1302 links / 496 fragments, code:format, pre-commit --all-files).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | —       |
| 3    | docs-reconciler | inherit | 1     | findings(85) | 70 stale passages + 15 missing across 16 files (readme 15 links/image, CLAUDE.md 14, ci-and-releases 9, release skill 5, docs-reconciler agent 7, mempalace.yaml 5, create-plan 5 incl. two references files outside U4's Owns, others 1–3); written to /tmp/dr-findings-2026-09-05-website.md and handed to U4.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | —       |
| 3    | U4              | inherit | 1     | green        | 15 files: readme (image + 15 links → site URLs, one sentence), CLAUDE.md (four homes, site row, three tag families, site:release ask-first, site:* tasks, ignores, dprint trap), installer/CLAUDE.md, site/CLAUDE.md (new), ci-and-releases, repo-shape, docs-reconciler agent, vwf/stackgen/plugin-authoring/create-plan/execute-plan/release skills, mempalace.yaml prose, the Workers decision record. DECIDED: readme link text reworded where it was the literal old path; CLAUDE.md:5 names all three release tasks; docs-ship rule, reconciler's quoted copy and mempalace cicd updated though unflagged; tag cell `site.yml → wrangler deploy` per Edit 2; repo-shape has no tree so none gained site/. DOCS FALSIFIED (outside Owns): create-plan/references/interview.md:31, :67 and plan-template.md:71, :83, :95 (site audience, site:release, docs/** paths, site:check gate line). GAP: no mempalace room claims site/, so non-docs site/ files route by filename (decision 18 says no site room) — flagged for the user; code:format re-padded the run log. |         |
| 3    | R3              | inherit | 1     | findings(2)  | site/CLAUDE.md:44 claims bad frontmatter is dropped silently — Astro's schema check fails the build loudly; site/CLAUDE.md:30 says mermaid loads on a language-mermaid block — the real trigger is a mermaid fence in the markdown source (shiki emits data-language). Both → U4 round 2. CONTRACT clean; RULINGS clean; all 16 readme targets exist in dist, dprint clean, mempalace.yaml rooms/keywords unchanged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |         |
| 3    | U4              | inherit | 2     | green        | site/CLAUDE.md: mermaid trigger stated as the markdown fence; frontmatter trap rewritten (schema errors fail astro build loudly).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 7ad714e |
| 3    | R3              | inherit | 2     | pass         | both findings resolved; CONTRACT clean; RULINGS clean.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |         |
| 3    | gate            | —       | 1     | green        | every line green (vitest 256/2, tsc ×2, npm-normalize 33, frozen install, site:check 22 pages / pagefind 20 / 1302 links / 496 fragments, pre-commit --all-files, code:format).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | —       |
| 4    | U5              | inherit | 1     | green        | generators byte-identical; no version bump (diff develop -- plugins/ installer/src package.json empty); every gate line 0 — site:check 22 pages built, pagefind 20, 1302 links / 496 fragments; release.yml identical to develop. GAP: code:format red only on the run-log table padding (formatter fixed it in place).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | —       |
| 4    | orchestrator    | —       | 2     | pass         | render at U5: landing and vwf docs screenshots unchanged from wave 2; 2 mermaid SVGs, 0 raw fences; anchor id="vwfarchitecture" ×1 and the how-to link /plugins/vwf/#vwfarchitecture; landing 0 em-dashes, 0 scripts; 404.html and sitemap-index.xml present.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | —       |
