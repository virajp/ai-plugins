---
name: doc-product-seed-scan
description: Read-only doc indexer for the /doc-product command's scan mode.
  Invoked only by /doc-product — do not delegate to it for general tasks.
