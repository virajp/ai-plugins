...
| Topic                                                                                                | When to read                                                                                        |
| ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [Topology detection](${CLAUDE_PLUGIN_ROOT}/skills/project-init/references/topology-detection.md)     | Inferring monorepo/polyrepo/workspace, project types, and stacks from repo signals                  |
| [Workspace structure](${CLAUDE_PLUGIN_ROOT}/skills/project-init/references/workspace-structure.md)   | The ideal workspace shape (parent + backend/frontend submodules) and the new-project recommendation |
