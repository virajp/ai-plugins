...
| [Workspace structure](${CLAUDE_PLUGIN_ROOT}/skills/project-setup/references/workspace-structure.md)   | The enforced workspace shape (parent + backend/frontend submodules), the stack-template menu, and rules |
