...
| [Structure](${CLAUDE_PLUGIN_ROOT}/skills/project-setup/references/workspace-structure.md)             | The topology menu (repo / monorepo / polyrepo), the stack-template axes, and the common-package rules |
