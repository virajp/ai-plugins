...
| [Workspace structure](${CLAUDE_PLUGIN_ROOT}/skills/project-setup/references/workspace-structure.md)   | The ideal workspace shape (parent + backend/frontend submodules) and the new-project recommendation |
