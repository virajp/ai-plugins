...
description: pubspec.yaml standards for a Flutter app — dependency declaration,
  SDK constraints, the lockfile, assets and native package-manager config.
  Auto-applies when editing pubspec.yaml.
license: MIT
