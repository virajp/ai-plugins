...
description: The Dart analyzer and lint configuration for a Flutter app — the
  shared ruleset, scoped exclusions, and the gate wiring. Auto-applies when
  editing analysis_options.yaml.
license: MIT
