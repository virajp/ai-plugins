---
name: architecting-apps
version: 0.1.0
category: development
description: Architects a Flutter app using the recommended layered approach
  (UI,
  Logic, Data) — separation of concerns, single source of truth, unidirectional
  data flow, and the Service/Repository/ViewModel/View workflow. Use when
  structuring a new Flutter app or refactoring for scalability.
license: MIT
