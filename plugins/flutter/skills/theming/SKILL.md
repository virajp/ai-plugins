...
description: Customizes the visual appearance of a Flutter app using the theming
  system — Material 3, ColorScheme.fromSeed, component *ThemeData
  normalization, button styling, and platform-adaptive idioms. Use when
  defining global styles, colors, or typography for a Flutter app.
license: MIT
