...
description: Manages application and ephemeral state in a Flutter app —
  choosing
  between setState for local state and MVVM + Provider with ChangeNotifier and
  unidirectional data flow for shared state. Use when sharing data between
  widgets or handling complex UI state transitions.
license: MIT
