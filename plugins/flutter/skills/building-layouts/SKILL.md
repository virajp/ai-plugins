...
description: Builds Flutter layouts using the constraint system and layout
  widgets — Row/Column/Stack, Expanded/Flexible, constraints, and adaptive
  responsive design. Use when creating or refining the UI structure of a
  Flutter app.
license: MIT
