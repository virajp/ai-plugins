...
description: Executes HTTP requests and handles JSON serialization in a Flutter
  app — safe URI construction, status-code handling, manual vs json_serializable
  serialization, and background parsing with compute(). Use when integrating
  with REST APIs or parsing structured data from external sources.
license: MIT
