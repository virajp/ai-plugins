---
name: plan-surveyor
description: Stateless desired-vs-actual surveyor for the /skill:plan command.
  Invoked only by /skill:plan — do not delegate to it for general tasks. Reads one
