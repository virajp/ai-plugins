...
happens later (`${CLAUDE_PLUGIN_ROOT}/assets/contract.md`) and ships the self-hosted
...
in the product's own datastore (`${CLAUDE_PLUGIN_ROOT}/assets/contract.md`). That is not
