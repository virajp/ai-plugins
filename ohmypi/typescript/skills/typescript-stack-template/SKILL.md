...
description: Return one TypeScript stack template as a vwf template payload —
  ...
  /skill:vwf-architecture and /skill:vwf-setup after the user picks from the typescript menu —
...
`/skill:typescript-stack-menu` lists, and nothing else. An unknown slug is
