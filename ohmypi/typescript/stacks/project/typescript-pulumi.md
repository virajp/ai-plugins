...
product parent. vwf enforces this (`/skill:vwf-doctor` raises a violation as
...
is reversible. `/skill:vwf-execute` treats an irreversible infrastructure apply as a
