...
description: Return one Flutter stack template as a vwf template payload — its
  ...
  /skill:vwf-architecture and /skill:vwf-setup after the user picks from the flutter menu —
...
`/skill:flutter-stack-menu` lists, and nothing else. An unknown slug is an
