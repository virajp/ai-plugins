...
| Skill                                                       | Returns                     |
| ------------------------------------------------------------- | --------------------------- |
| `/skill:design-tools-import-screens <flow> <platform>` | a **screens payload**       |
| `/skill:design-tools-import-design-system`             | a **design-system payload** |
...
> `/skill:setup` for the config migration.
...
Before delegating, `/skill:design-system` and `/skill:screens import` **check the
