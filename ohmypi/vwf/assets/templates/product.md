...
> `docs/blueprint/product.md`, authored by `/skill:product` — the Phase −1
...
<!-- The ordered "build next" list — flows first (the primary blueprint unit),
     ...
     /skill:blueprint and /skill:plan pick up first, and why. Re-rank on each /skill:product re-run;
