...
> `docs/blueprint/product.md`, authored by `/skill:vwf-product` — the Phase −1
...
<!-- The ordered "build next" list — flows first (the primary blueprint unit),
     ...
     /skill:vwf-blueprint and /skill:vwf-plan pick up first, and why. Re-rank on each /skill:vwf-product re-run;
