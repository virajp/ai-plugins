...
`/skill:vwf-product`, `/skill:vwf-architecture`, `/skill:vwf-design-system`, `/skill:vwf-blueprint`,
`/skill:vwf-screens`, `/skill:vwf-plan`, `/skill:vwf-setup`, and `/skill:vwf-feedback`. You own the user
...
transcript is what a later `/skill:vwf-recall` — or a reader of the mempalace
