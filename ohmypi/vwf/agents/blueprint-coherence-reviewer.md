...
description: Stateless whole-product coherence reviewer for the /skill:vwf-blueprint
  command. Invoked only by /skill:vwf-blueprint at the end of a sweep — do not
