...
description: Stateless completeness reviewer for the /skill:vwf-blueprint command.
  Invoked
  only by /skill:vwf-blueprint — do not delegate to it for general tasks. Checks a
