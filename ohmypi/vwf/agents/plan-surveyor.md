---
name: plan-surveyor
description: Stateless desired-vs-actual surveyor for the /skill:vwf-plan command.
  Invoked only by /skill:vwf-plan — do not delegate to it for general tasks. Reads one
