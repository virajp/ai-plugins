...
description: Security reviewer for the /skill:vwf-execute command. Invoked only by
  /skill:vwf-execute — do not delegate to it for general tasks. Threat-models the
...
3. **Trace real call paths.** Per `%%AI_PLUGINS_ROOT%%/assets/graphify.md`,
...
Per `%%AI_PLUGINS_ROOT%%/assets/memory.md`, before reporting you may
