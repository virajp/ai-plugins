...
- `/skill:vwf-plan` **may heal** a stale value, with user confirmation.
...
`%%AI_PLUGINS_ROOT%%/assets/examples/blueprint/` — a commerce slice where
every edge resolves. Read
[`flows/web/110-place-order/index.md`](%%AI_PLUGINS_ROOT%%/assets/examples/blueprint/flows/web/110-place-order/index.md)
...
[`entities/order/index.md`](%%AI_PLUGINS_ROOT%%/assets/examples/blueprint/entities/order/index.md)
