...
description: Capture the current session as a handoff document and file it to
  ...
  handoff, to mempalace and to docs/memory/handoff/next.md, which /skill:vwf-recall
...
mempalace was unreachable, and that `/skill:vwf-recall` will read the disk copy.
