...
[migration & consent](%%AI_PLUGINS_ROOT%%/skills/project-setup/references/migration-and-consent.md).
...
like the project axis, and `/skill:architecture` presents them **per project**.
