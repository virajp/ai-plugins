...
**declared preferences in the invocation text** (e.g. `/skill:vwf-execute`: "isolate
...
(e.g. `/skill:vwf-execute`: "commit only — do not prompt, never merge or push"), honor
