...
asset). Drift → report the delta and nudge `/skill:vwf-setup`; it is never doctor's
job to migrate.
...
**Callers.** `/skill:vwf-setup` step 10 runs this over the whole repo and records what
