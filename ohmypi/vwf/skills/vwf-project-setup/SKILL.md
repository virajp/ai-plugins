...
description: Onboarding and migration discipline for bringing a repo into vwf's
  ...
  section. Used by /skill:vwf-setup; trigger when onboarding a repo to vwf or migrating
...
| Topic                                                                                                 | When to read                                                                                          |
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [Topology detection](references/topology-detection.md)     | Inferring monorepo/polyrepo/workspace, project types, and stacks from repo signals                    |
| [Structure](references/workspace-structure.md)             | The topology menu (repo / monorepo / polyrepo), the stack-template axes, and the common-package rules |
...
Use with `/skill:vwf-setup`, which detects topology, migrates with consent,
