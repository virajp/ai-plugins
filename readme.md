...
one repo cannot separate them. `/vwf:doctor` raises a violation as a **blocking**
finding and `/vwf:setup` offers a consent-gated restructure; nothing else about
repo shape is enforced.
