...
| Topic                                                                              | When to read                                                                                                        |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [Effect-TS](<%= it.root %>/skills/effect/references/effect.md)              | Effect.gen, Effect.Schema, Effect.Service, error handling, telemetry, logging, config, the HTTP boundary            |
| [Effect runtime](<%= it.root %>/skills/effect/references/effect-runtime.md) | Composing & running Effect: Layer wiring, ManagedRuntime, Scope/acquireRelease, Schedule retries, Stream, TestClock |
| [Testing Effect](<%= it.root %>/skills/effect/references/testing.md)        | `it.effect`, providing test Layers, mocking a service, TestClock in tests                                           |
