...
description: Read the design system back from the project's design tool (Claude
  ...
  payload. Invoked by <%= it.cmd("vwf:design-system") %> as its design adapter — not a
...
| Tool            | Read                                                                                                      |
| --------------- | ----------------------------------------------------------------------------------------------------------- |
| `claude-design` | [claude-design](<%= it.root %>/skills/design-tools-import-design-system/references/claude-design.md) |
| `lovable`       | [lovable](<%= it.root %>/skills/design-tools-import-design-system/references/lovable.md)             |
| `stitch`        | [stitch](<%= it.root %>/skills/design-tools-import-design-system/references/stitch.md)               |
