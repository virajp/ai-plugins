...
description: Read a flow's designed screens back from the project's design tool
  ...
  payload. Invoked by <%= it.cmd("vwf:screens") %> import as its design adapter — not a
...
| Tool            | Read                                                                                                |
| --------------- | ----------------------------------------------------------------------------------------------------- |
| `claude-design` | [claude-design](<%= it.root %>/skills/design-tools-import-screens/references/claude-design.md) |
| `lovable`       | [lovable](<%= it.root %>/skills/design-tools-import-screens/references/lovable.md)             |
| `stitch`        | [stitch](<%= it.root %>/skills/design-tools-import-screens/references/stitch.md)               |
...
- **Report, don't interpret.** A component the design shows but the contract
  ...
  mistake is `<%= it.cmd("vwf:screens") %> import`'s job, and then `<%= it.cmd("vwf:blueprint") %>`'s.
