...
| Topic                                                                         | When to read                                                                                                                                                                     |
| ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Swift standards](<%= it.root %>/skills/swift/references/standards.md) | The always-on baseline: MethodChannel handlers from AppDelegate, main-thread dispatch, FlutterError codes, optionals, typed errors, concurrency (@MainActor / actors / Sendable) |
| [SwiftUI](<%= it.root %>/skills/swift/references/swiftui.md)           | Swift language fundamentals and SwiftUI patterns for native views                                                                                                                |
| [Xcode](<%= it.root %>/skills/swift/references/xcode/index.md)         | Xcode project structure, build settings, schemes, signing, simulators, and xcodebuild                                                                                            |
