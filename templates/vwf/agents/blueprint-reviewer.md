...
description: Stateless completeness reviewer for the <%= it.cmd("vwf:blueprint") %> command.
  Invoked
  only by <%= it.cmd("vwf:blueprint") %> — do not delegate to it for general tasks. Checks a
