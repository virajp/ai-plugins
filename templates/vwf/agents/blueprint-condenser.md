...
description: Stateless density pass for the <%= it.cmd("vwf:blueprint") %> command. Invoked only
  by <%= it.cmd("vwf:blueprint") %> — do not delegate to it for general tasks. Rewrites one
