...
description: Per-flow mockup renderer for the <%= it.cmd("vwf:mockups") %> command and
  <%= it.cmd("vwf:blueprint") %>'s §6a render step. Invoked only by those commands — do not
