...
description: Stateless whole-product coherence reviewer for the <%= it.cmd("vwf:blueprint") %>
  command. Invoked only by <%= it.cmd("vwf:blueprint") %> at the end of a sweep — do not
