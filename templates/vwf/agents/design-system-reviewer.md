...
description: Stateless completeness reviewer for the <%= it.cmd("vwf:design-system") %> command.
  Invoked
  only by <%= it.cmd("vwf:design-system") %> — do not delegate to it for general tasks. Checks a
