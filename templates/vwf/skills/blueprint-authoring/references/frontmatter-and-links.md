...
- `<%= it.cmd("vwf:plan") %>` **may heal** a stale value, with user confirmation.
...
`<%= it.root %>/assets/examples/blueprint/` — a commerce slice where
every edge resolves. Read
[`flows/web/110-place-order/index.md`](<%= it.root %>/assets/examples/blueprint/flows/web/110-place-order/index.md)
...
[`entities/order/index.md`](<%= it.root %>/assets/examples/blueprint/entities/order/index.md)
